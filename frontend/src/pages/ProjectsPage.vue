...
<template>
  <main class="mx-auto max-w-5xl px-6 py-6">
    <header class="lg:flex items-center justify-between gap-3 mb-4">
      <div class="flex gap-3 mb-4 justify-between lg:justify-normal lg:mb-0">
        <h1 class="m-0 text-3xl">Projects</h1>
        <AppButton @click="goNew">New project</AppButton>
      </div>

      <div class="flex gap-3 items-center justify-between lg:justify-normal">
      ...
      <AppTable>
        ...
        <tbody>
          <tr v-for="p in items" :key="p.id" class="border-b border-slate-200">
            <td class="px-2 py-2.5 wrap-break-word">
